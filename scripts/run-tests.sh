...
COLLECTION_NAMESPACE="joltcan"
PACKAGE_NAME="opconnect"
...
function do_tests() {
  ...
  ANSIBLE_COLLECTIONS_PATH="${collection_path}" ansible-test "${TEST_SUITE}" --skip-test shellcheck --docker "${DOCKER_IMG}" --python "${MIN_PYTHON_VERSION}"
}
